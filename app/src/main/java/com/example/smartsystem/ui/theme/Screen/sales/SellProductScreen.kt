...
@Composable
fun SellProductScreen(navController: NavHostController, productViewModel: ProductViewModel) {
    ...
    Scaffold(
        ...
        Column(
            ...
            Text(text = "Enter product details to sell", fontSize = 18.sp, color = Color.Gray)
